...
class EmployeeRepository {
    static findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                database_1.default.query('SELECT employee_id, full_name FROM employee', (error, results) => {
                    if (error) {
                        reject(error);
                    }
                    else {
    ...
    static findByFullName(fullName) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                database_1.default.query('SELECT * FROM employee WHERE full_name = ?', [fullName], (error, results) => {
                    if (error) {
                        reject(error);
                    }
                    else {
    ...
    static createEmployee(employee) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                database_1.default.execute(query, [employee.full_name, employee.password, employee.email, employee.celphone, employee.created_at, employee.created_by, employee.updated_at, employee.updated_by, employee.deleted], (error, result) => {
                    if (error) {
                        reject(error);
                    }
                    else {
    ...
    static updateEmployee(employee_id, employeeData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                database_1.default.execute(query, [employeeData.full_name, employeeData.password, employeeData.email, employeeData.celphone, employeeData.updated_at, employeeData.updated_by, employeeData.deleted, employee_id], (error, result) => {
                    if (error) {
                        reject(error);
                    }
                    else {
